...
=== Function module type changed or deleted

If a update or remote function module is deleted, an observation is reported.

Or if its changed from update or remote to normal function module.